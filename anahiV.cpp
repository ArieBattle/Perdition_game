...
#define IMG_BACKGROUND_PATH "./images/p2.png"
...
namespace anahi {
    ...
    //const void (*eventHandlers)()[] = { play, settings, quit };
...
void initMenu() // consider the struct options
{
    ...
    //changed all bb to p2 - just testing it out
